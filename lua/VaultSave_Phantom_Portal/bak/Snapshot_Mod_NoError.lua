...
local function log_all_components(game_object)
    ...
    if components then
        ...
        for i = 0, count - 1 do
            ...
            if comp then
                local type_name = comp:get_type_definition():get_FullName()
                ...
                if component and component:call("get_Enabled") then
                    ...
                    if filter_info then
                        ...
                        if old_mask ~= 0 then
                            ...
                            write_log("Disabled Collision Mask for " .. (component:get_type_definition():get_FullName() or "Unknown"))
                        end
                    else
                        component:call("set_Enabled", false)
                        table.insert(pending_components, component)
                        write_log("Disabled Component: " .. (component:get_type_definition():get_FullName() or "Unknown"))
                    end
                end
            end)
        end
        ...
        if movements then
            ...
            for i = 0, count - 1 do
                ...
                if movement and movement:call("get_Enabled") then
                    ...
                    write_log("Disabled PlayerMovement: " .. (movement:get_type_definition():get_FullName() or "Unknown"))
                end
            end
        end
    end)
